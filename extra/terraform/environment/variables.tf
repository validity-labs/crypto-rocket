...
variable "environment_label" {
  type        = string
  description = "The label of the environment. If this variable is not defined, the value of \"environment_name\" or the name of the current Terraform workspace will be used. Please note that the environment name can not be changed later."
  default     = ""
}

variable "domain" {
  description = "The domain name of the reporting engine."
  type        = string
}
