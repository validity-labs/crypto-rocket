...
import AssetSection from '@/components/pages/earn/deposit/AssetSection/AssetSection';

const EarnDepositPage: NextPage = () => {
  return (
    <>
      <Seo />
      <AssetSection />
...
export default EarnDepositPage;
