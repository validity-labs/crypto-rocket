export default function main(canvas: HTMLCanvasElement) {
  ...
  function getWebGLContext(canvas: HTMLCanvasElement) {
    ...
    let gl: any = canvas.getContext('webgl2', params) as WebGL2RenderingContext;
    const isWebGL2 = !!gl;
    if (!isWebGL2)
      gl = (canvas.getContext('webgl', params) ||
        canvas.getContext('experimental-webgl', params)) as unknown as WebGLRenderingContext;
...
`
  ...
  // let ditheringTexture = createTextureAsync('/images/pages/landing/texture.png');
  ...
  function updatePointerMoveData(pointer, posX, posY) {
    ...
    // console.log(pointer.deltaX, pointer.deltaY);
  ...
  function generateColor() {
    // linear-gradient(154deg, rgba(0,255,235,1) 0%, rgba(0,230,62,1) 100%);
    // return { r: 0, g: 255, b: 235 };
  ...
  const bind = () => {
    ...
    containerElement.addEventListener('touchstart', hanldeTouchStart);
    containerElement.addEventListener('touchmove', handleTouchMove, false);
  ...
  return () => {
    ...
    containerElement.removeEventListener('touchstart', hanldeTouchStart);
    containerElement.removeEventListener('touchmove', handleTouchMove, false);
